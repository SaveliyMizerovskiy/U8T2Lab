...
public class Algorithm2DArrays {
    ...
    { /* implement this method! */
        ...
        for (int row = 0; row < returnArr.length; row++) {
            for (int columns = 0; columns < returnArr[0].length; columns++) {
                returnArr[row][columns] = count;
                if (columns == 0){
                    System.out.println();
                }
    ...
    { /* implement this method! */
        ...
        boolean isO = false;
        for (int row = 0; row < returnArr.length; row++) {
            for (int column = 0; column < returnArr.length; column++) {
                if (isO){
                    returnArr[row][column] = "O";
                    isO = false;
                } else {
                    returnArr[row][column] = "X";
                    isO = true;
                }
            }
